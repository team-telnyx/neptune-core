...
pub trait RPC {
    ...
    /// [SymmetricKey](crate::models::state::wallet::address::symmetric_key::SymmetricKey)
    /// as the receiving address for any outputs destined for your own wallet.
    /// This happens automatically for the Change output only.
    ///
