...
impl GlobalState {
    ...
    /// of [TxOutput::auto()] for a description of the logic.
    ///
    ...
    /// [UtxoNotifyMethod::OnChain].  The change_key is a [SymmetricKey]
    /// in order to save blockchain space compared to a regular address.
    ///
